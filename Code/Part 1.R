...
# Implement Classification using Regression

#Canada
g_Can <- lm(GDP_Canada~y_Canada_Education1+y_Canada_Education2+y_Canada_Health1+y_Canada_Health2+y_Canada_Health3+
              y_Canada_Financial_Sector1+y_Canada_Financial_Sector2, df_Can)
summary(g_Can)

#Bhutan
g_Bhutan <- lm(GDP_Bhutan~y_Bhutan_Education1+y_Bhutan_Education2+y_Bhutan_Health1+y_Bhutan_Health2+y_Bhutan_Health3+
                 y_Bhutan_Financial_Sector1+y_Bhutan_Financial_Sector2, df_Bhutan)
summary(g_Bhutan)

#China
g_China <- lm(GDP_China~y_China_Education1+y_China_Education2+y_China_Health1+y_China_Health2+y_China_Health3+
                y_China_Financial_Sector1+y_China_Financial_Sector2, df_China)
summary(g_China)