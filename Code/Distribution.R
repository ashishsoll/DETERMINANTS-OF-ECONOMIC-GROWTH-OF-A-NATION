...
# Scatter Plots
data <- read.csv("E:/Ryerson University/Data Analytics and Big Data Certificate Course/Data Analytics Project/WB/Final/Education/Literacy.csv", header=TRUE)

ggplot(data, aes(x = Year, y = Can_Literacy_Rate))+geom_point()
ggplot(data, aes(x = Year, y = Can_Education_Expenditure))+geom_point()
ggplot(data, aes(x = Year, y = Chn_Literacy_Rate))+geom_point()
ggplot(data, aes(x = Year, y = Chn_Education_expenditure))+geom_point()
ggplot(data, aes(x = Year, y = Bhu_Literacy_Rate))+geom_point()
ggplot(data, aes(x = Year, y = Bhu_Education_expenditure))+geom_point()
...
ggplot(data, aes(x=x_Canada_Education1, y=y_Canada_Education1))+geom_line()+ggtitle('Adult Literacy Rate in Canada')+
...
ggplot(data, aes(x=x_Canada_Education2, y=y_Canada_Education2))+geom_line()+
  ggtitle('Current Education Expenditure as a Percentage of Direct Expenditure in Public Institutions for Canada')+
  xlab('Years')+ylab('Percentage')
...
ggplot(data, aes(x=x_Canada_Health1, y=y_Canada_Health1))+geom_line()+ggtitle('Life Expectancy at Birth in Canada')+
  xlab('Year')+ylab('Age')
...
ggplot(data, aes(x=x_Canada_Health2, y=y_Canada_Health2))+geom_line()+ggtitle('Usage of basic sanitation facilites in Canada')+
  xlab('Year')+ylab('Percentage of Population')
...
ggplot(data, aes(x=x_Canada_Health3, y=y_Canada_Health3))+geom_line()+ggtitle('Physicians per 1000 people in Canada')+
...
ggplot(data, aes(x=x_Canada_Financial_Sector1, y=y_Canada_Financial_Sector1))+geom_line()+ggtitle('Account Ownership in Canada')+
...
ggplot(data, aes(x=x_Canada_Financial_Sector2, y=y_Canada_Financial_Sector2))+geom_line()+ggtitle('Bank Capital to Assets Ratio in Canada')+
...
ggplot(data2, aes(x=x_Bhutan_Education1, y=y_Bhutan_Education1))+geom_line()+ggtitle('Adult Literacy Rate in Bhutan')+
  xlab('Years')+ylab('Percentage')
...
ggplot(data, aes(x=x_Bhutan_Education2, y=y_Bhutan_Education2))+geom_line()+
  ggtitle('Current Education Expenditure as a Percentage of Direct Expenditure in Public Institutions for Bhutan')+
  xlab('Years')+ylab('Percentage')
...
ggplot(data, aes(x=x_Bhutan_Health1, y=y_Bhutan_Health1))+geom_line()+ggtitle('Life Expectancy at Birth in Bhutan')+
  xlab('Year')+ylab('Age')
...
ggplot(data, aes(x=x_Bhutan_Health2, y=y_Bhutan_Health2))+geom_line()+ggtitle('Usage of basic sanitation facilites in Bhutan')+
  xlab('Year')+ylab('Percentage of Population')
...
ggplot(data, aes(x=x_Bhutan_Health3, y=y_Bhutan_Health3))+geom_line()+ggtitle('Physicians per 1000 people in Bhutan')+
  xlab('Year')+ylab('Numbers')
...
ggplot(data, aes(x=x_Bhutan_Financial_Sector1, y=y_Bhutan_Financial_Sector1))+geom_line()+ggtitle('Account Ownership in Bhutan')+
  xlab('Year')+ylab('Percentage')
...
ggplot(data, aes(x=x_Bhutan_Financial_Sector2, y=y_Bhutan_Financial_Sector2))+geom_line()+ggtitle('Bank Capital to Assets Ratio in Bhutan')+
  xlab('Year')+ylab('Ratio')
...
ggplot(data, aes(x=x_China_Education1, y=y_China_Education1))+geom_line()+ggtitle('Adult Literacy Rate in China')+
  xlab('Years')+ylab('Percentage')
...
ggplot(data, aes(x=x_China_Education2, y=y_China_Education2))+geom_line()+
  ggtitle('Current Education Expenditure as a Percentage of Direct Expenditure in Public Institutions for China')+
  xlab('Years')+ylab('Percentage')
...
ggplot(data, aes(x=x_China_Health1, y=y_China_Health1))+geom_line()+ggtitle('Life Expectancy at Birth in China')+
  xlab('Year')+ylab('Age')
...
ggplot(data, aes(x=x_China_Health2, y=y_China_Health2))+geom_line()+ggtitle('Usage of basic sanitation facilites in China')+
  xlab('Year')+ylab('Percentage of Population')
...
ggplot(data, aes(x=x_China_Health3, y=y_China_Health3))+geom_line()+ggtitle('Physicians per 1000 people in China')+
  xlab('Year')+ylab('Numbers')
...
ggplot(data, aes(x=x_China_Financial_Sector1, y=y_China_Financial_Sector1))+geom_line()+ggtitle('Account Ownership in China')+
  xlab('Year')+ylab('Percentage')
...
ggplot(data, aes(x=x_China_Financial_Sector2, y=y_China_Financial_Sector2))+geom_line()+ggtitle('Bank Capital to Assets Ratio in China')+
  xlab('Year')+ylab('Ratio')
...
ggplot(Canada_data_frame, aes(x=df_x_value, y=GDP_Canada))+geom_line()+
  ggtitle('Canda GDP Trend')+
  xlab('Years')+ylab('GDP (USD)')
...
ggplot(Bhutan_data_frame, aes(x=df_x_value, y=GDP_Bhutan))+geom_line()+
  ggtitle('Bhutan GDP Trend')+
  xlab('Years')+ylab('GDP (USD)')
...
ggplot(China_data_frame, aes(x=df_x_value, y=GDP_China))+geom_line()+
  ggtitle('China GDP Trend')+
  xlab('Years')+ylab('GDP (USD)')
