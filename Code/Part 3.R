...
#Canada
train_index_Can <- sample(1:nrow(df_Can), 0.7*nrow(df_Can))
train_set_Can <- df_Can[train_index_Can,]
train_set_labels_Can <- df_Can[train_index_Can,1]
test_set_Can <- df_Can[-train_index_Can,]
test_set_labels_Can <- df_Can[-train_index_Can,1]

prediction_Can <- knn(train=train_set_Can, test=test_set_Can, cl=train_set_labels_Can, k=4)
accuracy_Can <- 100 * sum(test_set_labels_Can==prediction_Can)/NROW(test_set_labels_Can)
accuracy_Can
table(prediction_Can, test_set_labels_Can)


#Bhutan
train_index_Bhutan <- sample(1:nrow(df_Bhutan), 0.7*nrow(df_Bhutan))
train_set_Bhutan <- df_Bhutan[train_index_Bhutan,]
train_set_labels_Bhutan <- df_Bhutan[train_index_Bhutan,1]
test_set_Bhutan <- df_Bhutan[-train_index_Bhutan,]
test_set_labels_Bhutan <- df_Bhutan[-train_index_Bhutan,1]

prediction_Bhutan <- knn(train=train_set_Bhutan, test=test_set_Bhutan, cl=train_set_labels_Bhutan, k=4)
accuracy_Bhutan <- 100 * sum(test_set_labels_Bhutan==prediction_Bhutan)/NROW(test_set_labels_Bhutan)
accuracy_Bhutan
table(prediction_Bhutan, test_set_labels_Bhutan)

#China
train_index_China <- sample(1:nrow(df_China), 0.7*nrow(df_China))
train_set_China <- df_China[train_index_China,]
train_set_labels_China <- df_China[train_index_China,1]
test_set_China <- df_China[-train_index_China,]
test_set_labels_China <- df_China[-train_index_China,1]

prediction_China <- knn(train=train_set_China, test=test_set_China, cl=train_set_labels_China, k=4)
accuracy_China <- 100 * sum(test_set_labels_China==prediction_China)/NROW(test_set_labels_China)
accuracy_China
table(prediction_China, test_set_labels_China)